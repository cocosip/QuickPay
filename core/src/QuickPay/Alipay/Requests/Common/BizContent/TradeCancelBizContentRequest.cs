...
{
    /// <summary>交易取消BizContent
    /// </summary>
    public class TradeCancelBizContentRequest: BaseBizContentRequest
    {
        ...
        /// <summary>Ctor
        /// </summary>
        public TradeCancelBizContentRequest()
        {
        ...
        public TradeCancelBizContentRequest(string outTradeNo)
        {
