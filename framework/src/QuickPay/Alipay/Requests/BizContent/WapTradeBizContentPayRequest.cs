...
{
    /// <summary>Wap网站支付BizContent请求
    /// </summary>
    public class WapTradeBizContentPayRequest : BaseBizContentRequest
    {
        ...
        public string ProductCode { get; set; } = AlipaySettings.ProductCode.Wap;
        ...
        /// <summary>Ctor
        /// </summary>
        public WapTradeBizContentPayRequest()
        {
        ...
        public WapTradeBizContentPayRequest(string subject, string body, string outTradeNo, string totalAmount)
        {
            Subject = subject;
            Body = body;
