...
namespace QuickPay.Alipay.Services.DTOs
{
    /// <summary>支付宝支付
    /// </summary>
    [AutoMapTo(typeof(AppTradeBizContentPayRequest))]
    public class AppTradePayInput : UniqueIdModel
    {
        ...
        public AppTradePayInput(string subject, string body, string outTradeNo, string totalAmount)
        {
            Subject = subject;
            Body = body;
