...
namespace QuickPay.WechatPay.Services.Impl
{
    ...
    public class WechatJsApiPayService : BaseWechatPayService, IWechatJsApiPayService
    {
        ...
        public WechatJsApiPayService(IAmbientScopeProvider<WechatPayAppOverride> wechatPayAppOverrideScopeProvider, IAuthenticationService authenticationService) : base(wechatPayAppOverrideScopeProvider)
        {
        ...
        public async Task<JsSdkConfigResponse> GetJsSdkConfig(string currentUrl)
        {
            ...
            Logger.Info(WechatPayUtil.ParseLog($"获取微信JsApiTicket:{jsApiTicket}"));
