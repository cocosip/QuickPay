...
namespace QuickPay.Alipay.Services.DTOs
{
    /// <summary>手机网站支付
    /// </summary>
    [AutoMapTo(typeof(WapTradeBizContentPayRequest))]
    public class WapTradePayInput : UniqueIdModel
    {
        ...
        public WapTradePayInput(string subject, string body, string outTradeNo, string totalAmount)
        {
            Subject = subject;
            Body = body;
        ...
        public WapTradePayInput(string subject, string body, string outTradeNo, string totalAmount, string notifyUrl, string returnUrl)
        {
            Subject = subject;
            Body = body;
            OutTradeNo = outTradeNo;
        ...
        /// <param name="returnUrl">同步返回地址</param>
        public WapTradePayInput(string subject, string body, string outTradeNo, string totalAmount, Type notifyType, string returnUrl)
        {
            Subject = subject;
            Body = body;
            OutTradeNo = outTradeNo;
