...
{
    /// <summary>App支付BizContent
    /// </summary>
    public class AppTradeBizContentPayRequest : BaseBizContentRequest
    {
        ...
        public string ProductCode { get; set; } = AlipaySettings.ProductCode.App;
        ...
        /// <summary>Ctor
        /// </summary>
        public AppTradeBizContentPayRequest()
        {
        ...
        public AppTradeBizContentPayRequest(string subject, string body, string outTradeNo, string totalAmount)
        {
            Subject = subject;
            Body = body;
